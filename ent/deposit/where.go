...
func HasFund() predicate.Deposit {
...
func HasFundWith(preds ...predicate.Fund) predicate.Deposit {
	return predicate.Deposit(func(s *sql.Selector) {
		step := newFundStep()
...
func HasCustomer() predicate.Deposit {
	return predicate.Deposit(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCustomerWith(preds ...predicate.Customer) predicate.Deposit {
	return predicate.Deposit(func(s *sql.Selector) {
